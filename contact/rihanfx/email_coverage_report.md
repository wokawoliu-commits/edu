...
从 19/80 的邮箱覆盖基线开始，累计通过公开官网、官方 Contact 页、条款/隐私页、直接 URL 复核和 Playwright 渲染复核，新增了 7 家可回填公司。加上已在该基线内的 Supercent，本报告共记录 8 个重点回填案例。
...
注：累计回填清单包含 8 个公司行，其中 Supercent 是上一次单点验证前已经同步进当前基线的回填项；从 19/80 到 26/80 的覆盖率净增为 7 家。
...
新版策略已经把“静态抓不到但页面渲染后可见”的情况覆盖进来，但对剩余 54 家缺口没有带来新的安全回填邮箱。当前公开邮箱覆盖率停在 32.5%。如果要继续提高可触达率，下一步应从“找邮箱”转向“找路径”：
